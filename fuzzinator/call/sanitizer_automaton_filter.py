...
class SanitizerAutomatonFilter(RegexAutomatonFilter):
    ...
    def __init__(self, **kwargs):
        ...
        stderr_patterns.extend([
            ...
            # STACK_FRAME_REGEXES:
            r'mat /' + self.STACK_PREFIX + self.STACK_FUNCTION_OFFSET + self.STACK_FILE_LINE_CHAR + r'/',
            r'mat /' + self.STACK_PREFIX + self.STACK_FUNCTION_OFFSET + self.STACK_MODULE_OFFSET + r'/',
            r'mat /' + self.STACK_PREFIX + self.STACK_FUNCTION_MODULE_OFFSET + r'/',
            r'mat /' + self.STACK_PREFIX + self.STACK_FUNCTION_OFFSET + r'/',
            r'mat /' + self.STACK_PREFIX + self.STACK_MODULE_OFFSET + r'/',
