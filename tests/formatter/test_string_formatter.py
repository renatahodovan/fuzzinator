...
def test_string_formatter(issue, formatter_init_kwargs, formatter_kwargs, exp_dict, exp_key):
    assert exp_dict[exp_key] == fuzzinator.formatter.StringFormatter(**formatter_init_kwargs)(issue=issue, **formatter_kwargs)
