...
@pytest.mark.parametrize('fuzzer, fuzzer_init_kwargs, dec_kwargs, exp_flip_cnt', [
    (mock_exhausted_fuzzer, None, {'frequency': '100'}, None),
...
def test_byte_flip_decorator(fuzzer, fuzzer_init_kwargs, dec_kwargs, exp_flip_cnt):
    fuzzer = fuzzinator.fuzzer.ByteFlipDecorator(**dec_kwargs)(fuzzer)
